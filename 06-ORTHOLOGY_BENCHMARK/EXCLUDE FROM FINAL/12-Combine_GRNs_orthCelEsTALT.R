...
orthCelEsT <- read.table("output/GRNs/orthCelEsTALT_equalweights.txt", header = TRUE)
...
commonTFs <- base::intersect(base::intersect(unique(eY1H_net$source), unique(ChIPorth500$source)), unique(TF_orth1500fdr5$source))
